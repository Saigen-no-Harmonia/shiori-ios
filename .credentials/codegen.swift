...
do {
	...
	let credentialsSourceURL = currentDirectoryURL
    .deletingLastPathComponent()
    .appendingPathComponent("ShioriPackage", isDirectory: true)
    .appendingPathComponent("Sources", isDirectory: true)
    .appendingPathComponent("Utility", isDirectory: true)
    .appendingPathComponent("Credentials", isDirectory: true)
    .appendingPathComponent(credentialsSourceFile)
    let credentialsSourcePath = credentialsSourceURL.path
